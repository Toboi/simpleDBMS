...
*/
struct attribut* tbl_get_attr(struct tbl_header* table, char attr_name[ ], int* returnVal);

/*
Gibt einen Zeiger auf den Attribut-Wert zum Attribut attr_name vom tupel zurück.
*/
int* tbl_get_attrval_from_tupel(struct tbl_header table, int* tupel, char attr_name[ ]);
